...
public class SecuritySelector implements CadetSelection {
	private final Set<String> qualifyingSkills = new HashSet<>(Arrays.asList("PW", "BD", "VDG"));
	private final int qualifyingHeight = 190;
